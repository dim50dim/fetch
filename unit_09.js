...
function f1() {
       ...
       document.querySelector('.out-1').style.height = '100px';
}
...
function f6() {
    let parags  = document.querySelectorAll('.p-6');
    document.querySelector('.out-6').innerHTML = parags.length;
}
